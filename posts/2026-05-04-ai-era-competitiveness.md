...
上一篇 [《接近 10 年没写代码了，被 Claude Opus 4.5 拉了回来》](/thought/2026-04-28-return-to-code.html) 我聊了「Claude 永动机」。脑子里想，顺手写出来，让 Claude 干，我 review。

那篇结尾我留了一个题：**下一代组织会长什么样。**

我这阵子的答案越来越清楚。组织的最小单元，从"一支团队"变成"**1 个人 + 一支 Agent 团队**"。1+N。

但说出 1+N 只是答了一半。真正难的是："1" 自己留下什么？"N" 接走什么？
换句话说：**你工作里那不可替代的 20% 是什么？另外 80% 怎么交给 AI？**

我看身边就很明显：同一家公司、同样的活，有人 1 小时干完，有人 1 天干完。差距不是智商，是这两个问题想没想清楚。
...
判断力是关于**方向**的：要做什么、不做什么。AI 能帮你列选项、算账、推演，但拍板那一下它替不了。判断错方向，AI 会以极快的速度把错误执行到底，错判的代价反而比以前更大。会做正确决策的人，会越来越贵。

<strong style="color: var(--accent)">2. 品味</strong>：100 个版本里，哪一个感觉对？

品味是关于**质感**的：文案的语气、视觉的留白、交互的"顺不顺"，没标准答案，只有"对劲"或"不对劲"。AI 能批量产 100 个能跑的版本，但 100 个里只有少数有那个味儿。能挑出来的人，越来越值钱。
...
几十年才能练出来的手感，AI 没法替你压缩。这层不只不会被替代，反而越来越贵。市场被 AI 抹平之后，没被抹平的那批人会被疯抢。
...
两边是乘法：只有累积、不出场，credit 会慢慢被忘掉；只有当下、没沉淀，每次都从零开始。
...
但底层都一样。你不可替代的那 20% 是什么？AI 怎么吃掉另外的 80%？
...
**他们的 20% 落在公式的不同位置，但每个人都把自己的那一块挑得很清楚，剩下的全交给 AI。**

不是"我做完了再让 AI 帮我改改"。
是先想清楚那 20%，再用 AI 把另外 80% 拿掉。

这就是 AI 原生和顺手用 AI 的区别。
...
把那 20% 持续往深里练：判断、品味、在场、关系、手艺。这是你的本钱，是 AI 替不了的部分，越练越值钱。

把那 80% 持续交给 AI 跑：一切重复的、可流程化的活。这是你的杠杆，让你一个人能干过去一支团队的事。

只练 20% 不用 AI，你跑不过用 AI 的人；只用 AI 不练 20%，做出来的东西迟早跟 AI 没区别。两件事得一起做，停一边，另一边也撑不住。
