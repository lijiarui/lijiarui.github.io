...
date: 2016-12-10
category: chatbot
tags: Wechaty, Chatbot, 微信, 教程
slug: 2016-12-10-try-to-write-wexinrobot
description: 从舞蹈社群运营聊起，一步一步用 Wechaty 写一个最简单的微信机器人。
---

我一直和我的小伙伴在业余时间拍摄舞蹈教学视频，叫“舞哩”，原创了几百个视频，近千万的播放，所以就建了微信群来和粉丝交流。

![RuiRui](/img/posts/2016-12-10-try-to-write-wexinrobot/ruirui-dance.webp)
...
因为我只对JavaScript比较熟悉，所以选择了Wechaty，他是使用Typescript进行编写的Node项目，是一个专门为个人微信号搭建的bot框架，使用Wechaty的API，只需要6行Javascript代码就可以搭建一个最简单的微信机器人，支持 Linux, Windows, Darwin(OSX/Mac) 和Docker。 ![wechaty-pic](/img/posts/2016-12-10-try-to-write-wexinrobot/lijiarui-write-bot-wechaty-pic.webp)
...
首次运行以后会有如下的截图： ![docker-pull](/img/posts/2016-12-10-try-to-write-wexinrobot/lijiarui-write-bot-docker-pull.webp)

Docker会自动的将相关的包部署到电脑里面，安装成功后，以后再运行就会是如下的截图了： ![run-ding](/img/posts/2016-12-10-try-to-write-wexinrobot/lijiarui-write-bot-run-ding.webp)
...
![qr-code](/img/posts/2016-12-10-try-to-write-wexinrobot/lijiarui-write-bot-qr-code.webp)
