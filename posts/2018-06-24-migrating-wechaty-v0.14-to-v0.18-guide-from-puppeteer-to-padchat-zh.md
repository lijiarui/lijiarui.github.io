...
slug: 2018-06-24-migrating-wechaty-v0.14-to-v0.18-guide-from-puppeteer-to-padchat-zh
description: Author: @lijiarui Founder of BotOrange, Author of Wechaty. Wechaty 近期有了很大的升级，从0.14版本之后，开始陆续支持各类非Web 版本的解决方案。
---
...
## Room.add() 返回值从Promise 变成了 Promise
...
2. Error: must not use the global Message/Contact/Room. use a cloned child via cloneClass instead
